...
const ChatBot: React.FC = () => {
  ...
  return (
    <>
      ...
      {!isOpen && !isTyping && (
        <div className="fixed bottom-20 right-4 bg-green-500 text-white px-4 py-2 rounded-lg shadow-lg animate-bounce-in z-50">
          {displayedText}
        </div>
      )}
      ...
      {!isOpen && (
        <button
          className="fixed bottom-4 right-4 bg-green-500 text-white p-4 rounded-full shadow-lg hover:scale-105 transition-transform duration-200 hover:bg-green-600 focus:outline-none animate-bounce z-50"
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-4 right-4 w-96 bg-white shadow-lg rounded-lg border border-gray-200 animate-scale-in z-50">
